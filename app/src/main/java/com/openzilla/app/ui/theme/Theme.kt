...
fun OpenZillaTheme(
    ...
    val scheme = when {
        ...
        useDark -> darkColorScheme(
            ...
            primaryContainer = tone(seedDark, 0.55f, towardWhite = false),
            onPrimaryContainer = tone(seedDark, 0.75f, towardWhite = true),
            inversePrimary = tone(seedDark, 0.4f, towardWhite = true),
            secondary = tone(seedDark, 0.35f, towardWhite = true),
            secondaryContainer = tone(seedDark, 0.6f, towardWhite = false),
            onSecondaryContainer = tone(seedDark, 0.8f, towardWhite = true),
            tertiary = tone(seedDark, 0.5f, towardWhite = true),
            tertiaryContainer = tone(seedDark, 0.65f, towardWhite = false),
            onTertiaryContainer = tone(seedDark, 0.8f, towardWhite = true),
            ...
            primary = seedLight,
            onPrimary = Color.White,
            primaryContainer = tone(seedLight, 0.80f, towardWhite = true),
            onPrimaryContainer = tone(seedLight, 0.60f, towardWhite = false),
            inversePrimary = tone(seedLight, 0.5f, towardWhite = true),
            secondary = tone(seedLight, 0.25f, towardWhite = false),
            secondaryContainer = tone(seedLight, 0.85f, towardWhite = true),
            onSecondaryContainer = tone(seedLight, 0.65f, towardWhite = false),
            tertiary = tone(seedLight, 0.35f, towardWhite = false),
            tertiaryContainer = tone(seedLight, 0.85f, towardWhite = true),
            onTertiaryContainer = tone(seedLight, 0.65f, towardWhite = false),
...
private fun oledColorScheme(primary: Color, onPrimary: Color, secondary: Color, tertiary: Color): ColorScheme =
    darkColorScheme(
        primary = primary,
        onPrimary = onPrimary,
        primaryContainer = tone(primary, 0.6f, towardWhite = false),
        onPrimaryContainer = tone(primary, 0.75f, towardWhite = true),
        inversePrimary = tone(primary, 0.4f, towardWhite = true),
        secondary = secondary,
        secondaryContainer = tone(primary, 0.7f, towardWhite = false),
        onSecondaryContainer = tone(primary, 0.8f, towardWhite = true),
        tertiary = tertiary,
        tertiaryContainer = tone(primary, 0.72f, towardWhite = false),
        onTertiaryContainer = tone(primary, 0.8f, towardWhite = true),
